...
{
    var o = null; // namespace "http://eventslogdb.asecurity.com/",
    var nd = SOAPClient._getElementsByTagName(req.responseXML, "ns2:"+method+"Response")[0]; //xdoc.firstChild.firstChild.firstChild;
    if (nd == null)
        nd = SOAPClient._getElementsByTagName(req.responseXML, method+"Response")[0];
...
{
    var xmlHttp = SOAPClient._getXmlHttp();
    xmlHttp.open("GET", glUrl + "?xsd=1", true);
    var wsdlTypes = new Array();
    xmlHttp.onreadystatechange = function () {
        if (xmlHttp.readyState == 4) {
            wsdl = xmlHttp.responseXML;
